...
const RightToDown = ({ width = "100%", height = "100%", isOilFlowing }) => {
  ...
  return (
    ...
    >
      ...
      <line x1="80" y1="90" x2="80" y2="180" stroke="black" strokeWidth="3" />
      <line x1="90" y1="80" x2="180" y2="80" stroke="black" strokeWidth="3" />
      ...
      />
      <path
        d="M 80 90 Q 80 83, 91 80"
        fill="none"
        stroke="black"
        strokeWidth="3"
      />

      {/* <!-- <path d="M 80 90 Q 85 85, 90 80" fill="none" stroke="black" strokeWidth="3"/> more of a curve --> */}
