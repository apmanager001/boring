    ...
    <section className="my-24 flex box-border justify-center items-center">
      <div className="bg-[#dfa674] rounded-2xl flex max-w-3xl p-5 items-center">
        <div className="md:w-1/2 px-8">
          ...
          <p className="text-sm mt-4 text-[#002D74]">Easily register now.</p>
          ...
          <div className="mt-4 text-sm flex justify-between items-center container-mr">
            <p className="mr-3 md:mr-0 text-white">If you already have an account..</p>
            <a href="/login">
        ...
        <div className="md:block hidden w-1/2 h-80 mx-auto overflow-hidden rounded-2xl">
          <img
            className="rounded-2xl max-h-[1600px] object-cover transform scale-175 "
            loading="lazy"
